...
var groceryStore = {
    produce: ["Apples", "Pears", "Peaches", "Bananas", "Oranges", "Lemons", "Limes", "Kiwis", "Clementines", "Strawberries", "Blueberries", "Raspberries", "Blackberries", "Honeydew melon", "Watermelon", "Cantaloupe", "Pineapple", "Tomatoes", "Avocados", "Cherry tomatoes", "Sweet peppers", "Mushrooms", "Beets", "Green beans", "Brussel sprouts", "Parsley", "Cilantro", "Fresh dill", "Chives", "Rosemary", "Sage leaves", "Thyme", "Basil", "Radishes", "Broccoli", "Cauliflower", "Carrots", "Red cabbage", "Fennel", "Leek", "Swiss chard", "Celery", "Cucumber", "Scallion", "Lettuce", "Arugula", "Romaine lettuce", "Spinach", "Asparagus", "Zucchini", "Bell pepper", "Corn", "Red onion", "Yellow onion", "Yukon gold potatoes", "Potatoes", "Sweet potatoes", "Garlic cloves", "Ginger"],
    deli: ["Giovanni Rana pasta", "Alfredo sauce", "Hummus", "Turkey", "Ham", "Roast beef", "Mortadella", "American cheese", "Swiss cheese", "Pita bread", "Dinner rolls", "Dried cranberries", "Golden raisins", "In shell nuts", "Sliced almonds", "Walnuts", "Pecans", "Olives", "Feta cheese", "Monterey jack cheese", "Gorgonzola", "Goat cheese", "Gouda", "Grana padano", "Fig jam", "Egg salad", "Chicken salad", "Quiche", "Sushi"],
    meat: ["Salmon", "Smoked Salmon", "White fish", "Bratwurst", "Pork chops", "Ground beef", "Meatloaf meat", "Ground turkey", "Chicken", "Hot dogs", "Bacon"],
    organics: ["Almond butter", "Cliff bars", "Potato chips", "Veggie chips", "Chia seeds", "Flax seed"],
