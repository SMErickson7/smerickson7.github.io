function setStyleSheet(url, color) {
    ...
    hero.setAttribute('style', "background: url(img/headers/header-" + color + ".jpg)");
...
$(document).ready(function() {
    ...
    function setThemeFromCookie() {
        if (typeof Cookies.get('theme') !== "undefined") {
            ...
            $('#hero').attr("style", "background: url(img/headers/header-" + theme + ".jpg)");
            console.log("Cookie loaded: " + theme);
        } else {
            Cookies.set('theme', 'blue', { expires: 90 });
        }
    }
});